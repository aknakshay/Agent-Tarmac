...
<p align="center">
  <a href="https://github.com/akshaynagpal/agent-tarmac/actions/workflows/ci.yml"><img src="https://github.com/akshaynagpal/agent-tarmac/actions/workflows/ci.yml/badge.svg" alt="CI status" /></a>
...
```sh
git clone https://github.com/akshaynagpal/agent-tarmac.git
cd agent-tarmac
npm install
npm run tauri build
```
